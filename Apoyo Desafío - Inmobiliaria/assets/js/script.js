const propiedadesVenta = {
    ...
    propiedades: [
      ...
      },
      {
        ...
        description: 'Esta casa moderna ofrece una vista espectacular al mar',
        location: '333 Coastal Road, Seaside Estate, CA 67890',
        bedrooms: 4,
        bathrooms: 4,
        cost: 5000,
        smoke: false,
      ...
      },
      {
        ...
        title: 'Casa moderna con terraza panorámica',
        description: 'Esta casa moderna cuenta con una terraza panorámica que ofrece vistas impresionantes',
        location: '444 Scenic Terrace, Hilltop Heights, CA 78901',
        bedrooms: 4,
        bathrooms: 4,
        cost: 5200,
        smoke: true,
  ...
  const propiedadesAlquiler = {
    ...
    },
    {
      ...
      description: 'Esta casa de 3 habitaciones tiene una vista hermosa al parque',
      location: '789 Greenway Lane, Parkview, CA 67890',
      bedrooms: 3,
      bathrooms: 2,
      cost: 1800,
      smoke: true,
      ...
      ,
    {
      ...
      title: 'Casa de lujo en zona exclusiva con vista al parque',
      description: 'Esta casa de lujo está situada en una exclusiva zona residencial con vista al parque',
      location: '789 Park Lane, Prestige Side, BA 33421',
      bedrooms: 4,
      bathrooms: 2,
      cost: 4600,
      smoke: false,
